...
const LoginForm: React.FC<LoginFormProps> = ({ isOpen, onClose, fromCart = false }) => {
  ...
  useEffect(() => {
    if (isAuthenticated && isOpen) {
      setTimeout(() => {
        onClose();
        if (fromCart) {
          // اگر از سبد خرید آمده بود، صفحه را رفرش می‌کنیم تا سبد خرید آپدیت شود
