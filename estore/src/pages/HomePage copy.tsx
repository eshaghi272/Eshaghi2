        ...
        <div className="container relative mx-auto px-4 py-16 md:py-24">
          <div className="max-w-3xl">
            <div className="flex items-center mb-4">
              <BadgeCheck className="w-8 h-8 mr-3" />
              <span className="text-blue-200 font-medium">تضمین بهترین قیمت</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              تجربه خریدی <span className="text-yellow-300">استثنایی</span> با eStore
            </h1>
            ...
            <div className="flex flex-wrap gap-8 mt-16 pt-8 border-t border-white/20">
              ...
              <div>
                <div className="text-3xl font-bold">۲۴h</div>
                <div className="text-blue-200">ارسال در تهران</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute right-10 top-10 hidden lg:block">
            <div className="relative w-96 h-96">
              <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 to-pink-500 rounded-full blur-3xl opacity-20"></div>
            </div>
          </div>
        </div>
      </section>
