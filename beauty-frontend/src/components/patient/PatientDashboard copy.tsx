...
export default function PatientDashboard() {
  ...
  const quickActions = [
    ...
    { icon: <FaChartBar />, label: 'گزارشات', link: '/admin/reports', color: 'bg-red-500' }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-2">
              ...
              {clinicInfo && <span className="text-xs text-gray-400 mr-2">| {clinicInfo.clinicName}</span>}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="card dark:bg-gray-800 bg-gold-light/10 dark:bg-gold-dark/5">
              <div className="flex items-center gap-2 mb-3">
                <FaHospital className="text-gold text-xl" />
                <h3 className="text-lg font-bold text-darkblue dark:text-white">اطلاعات کلینیک</h3>
              </div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">نام</span>
                  <span className="font-medium text-darkblue dark:text-white">{clinicInfo?.clinicName || '-'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">کد</span>
                  <span className="font-medium text-darkblue dark:text-white">{clinicInfo?.clinicCode || '-'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">تلفن</span>
                  <span className="font-medium text-darkblue dark:text-white">{clinicInfo?.phone || '-'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">پزشکان</span>
                  <span className="font-medium text-darkblue dark:text-white">{stats?.totalDoctors || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">بیماران</span>
                  <span className="font-medium text-darkblue dark:text-white">{stats?.totalPatients || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">ماه</span>
                  <span className="font-medium text-darkblue dark:text-white">{stats?.month}/{stats?.year}</span>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="card dark:bg-gray-800 bg-gradient-to-r from-green-50/30 to-green-50/10 dark:from-green-900/20">
            <h4 className="font-bold text-darkblue dark:text-white mb-2">📊 آمار</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">
