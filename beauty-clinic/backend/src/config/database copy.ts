...
db.exec(`
  ...
  -- ============================================
  -- جدول اقلام درمانی (مواد و داروها)
  -- ============================================
  ...
  -- ============================================
  -- جدول زمان‌های استراحت
  -- ============================================
  CREATE TABLE IF NOT EXISTS tbl_break_times (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    clinicId INTEGER DEFAULT 1,
    doctorId INTEGER NOT NULL,
    dayOfWeek INTEGER NOT NULL,
  ...
  -- ============================================
  -- جدول نوبت‌های غیرفعال
  -- ============================================
  CREATE TABLE IF NOT EXISTS tbl_unavailable_dates (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    clinicId INTEGER DEFAULT 1,
    doctorId INTEGER NOT NULL,
    fdate TEXT NOT NULL,
  ...
  CREATE INDEX IF NOT EXISTS idx_materials_active ON tbl_materials(isActive);
  
  CREATE INDEX IF NOT EXISTS idx_medicines_clinic ON tbl_medicines(clinicId);
  CREATE INDEX IF NOT EXISTS idx_medicines_active ON tbl_medicines(isActive);
  ...
  CREATE INDEX IF NOT EXISTS idx_treatments_date ON tbl_treatments(createdAt);
  
  CREATE INDEX IF NOT EXISTS idx_treatment_items_clinic ON tbl_treatment_items(clinicId);
  CREATE INDEX IF NOT EXISTS idx_treatment_items_treatment ON tbl_treatment_items(treatmentId);
  CREATE INDEX IF NOT EXISTS idx_treatment_items_type ON tbl_treatment_items(itemType);
  
  CREATE INDEX IF NOT EXISTS idx_treatment_extra_clinic ON tbl_treatment_extra_costs(clinicId);
  CREATE INDEX IF NOT EXISTS idx_treatment_extra_treatment ON tbl_treatment_extra_costs(treatmentId);
  ...
  CREATE INDEX IF NOT EXISTS idx_inventory_category ON tbl_inventory(category);
  ...
  CREATE INDEX IF NOT EXISTS idx_notifications_read ON tbl_notifications(isRead);
  ...
  CREATE INDEX IF NOT EXISTS idx_otp_code ON tbl_otp_codes(code);
`);
